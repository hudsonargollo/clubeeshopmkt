...
echo ""
echo -e "${CYAN}🌐 Custom Domain: https://eshop.clubemkt.digital${NC}"
echo -e "${CYAN}🌐 Workers URL: https://clubeeshopmkt.hudsonargollo2.workers.dev${NC}"
echo -e "${CYAN}📱 Test the signup page: https://eshop.clubemkt.digital/signup${NC}"
echo ""
